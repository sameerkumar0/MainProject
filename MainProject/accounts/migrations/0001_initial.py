    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('manager', 'Manager'), ('employee', 'Employee')], default='employee', max_length=10)),
                ...
                ('technologies', models.ManyToManyField(blank=True, related_name='users', to='accounts.technology')),
